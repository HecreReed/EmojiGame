...
class Enemy(Emoji):
    def __init__(self, boostspeed=0):
        ...
        self.isboss = False
        self.rint = 1
        if Game.bossdeathtimes - 1 <= 3:
            self.rint = random.randint(1, 4 + Game.bossdeathtimes - 1)
        else:
        ...
        self.live = 50
        if self.rint == 1:
            self.live = 30 * Game.bossdeathtimes
            self.maxlive = 30 * Game.bossdeathtimes
        elif self.rint == 2:
            self.live = 50 * Game.bossdeathtimes
            self.maxlive = 50 * Game.bossdeathtimes
        elif self.rint == 3:
            self.live = 70 * Game.bossdeathtimes
            self.maxlive = 70 * Game.bossdeathtimes
        elif self.rint == 4:
            self.live = 100 * Game.bossdeathtimes
            self.maxlive = 100 * Game.bossdeathtimes
        elif self.rint == 5:
            self.live = 120 * Game.bossdeathtimes
            self.maxlive = 120 * Game.bossdeathtimes
        elif self.rint == 6:
            self.live = 150 * Game.bossdeathtimes
            self.maxlive = 150 * Game.bossdeathtimes
        elif self.rint == 7:
            self.live = 200 * Game.bossdeathtimes
            self.maxlive = 200 * Game.bossdeathtimes
        self.allbumb = []
    ...
    def circleshoot(self):
        ...
        artan = 0
        lenth = 40
        ex = Game.wateremoji.x
        ey = Game.wateremoji.y
        if ex - self.x != 0:
    ...
    def randomshoot(self):
        ...
        bumb.image = Game.bulluten[8]
        bumb.speed = 30
        bumb.tan = random.random() * 2.4 - 1.2
        Game.allenbumbs.append(bumb)
